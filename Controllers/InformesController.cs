...
namespace IA_ToSave_Project.Controllers
{
    ...
    public class InformesController : ControllerBase
    {
        ...
        public object GetInforme()
        {
            ...
            var query = from inf in _context.Informes
                        join inc in _context.Incidencias on inf.IdInf equals inc.IdIcdc
                        select new InformesMV
                        {
                             ID_Informacion = inf.IdInf,
                             Num_Informe = inf.NInf,
                            Hora = inc.Hora,
                            Descripcion = inf.Descr,
                            Arma = inc.Anmla
